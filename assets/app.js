...
------------------------------------------------------------------*/ document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if ($productSlider) {
        ...
        let product_nav = new (0, _flickityDefault.default)('.js-product-nav-imagery-slider', {
...
},{"53eb4150d4ea9072":"lGlvh","e80092d622ffe6e6":"l5E56"}]},["cklYw","fWapj"], "fWapj", "parcelRequire94c2")
